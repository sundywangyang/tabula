...
| 阶段 | 内容 | 状态 |
|---|---|---|
| **P0 脚手架** | pnpm + Electron + Vite + React + TS,基础窗口 + IPC 通路 | ✅ 完成 |
| **P1 核心浏览** | 文件列表 / 面包屑 / 地址栏 / 排序 / 视图模式 / 键盘导航 | ✅ 完成 |
| **P2 标签 + 窗格** | 多标签、多窗格、拖拽、焦点切换、多窗口 | ✅ 完成 |
| **P3 文件操作** | 复制 / 移动 / 删除 / 重命名 / 拖放 / 回收站 | ✅ 完成 |
| **P4 预览 + 搜索** | QuickLook、Markdown / 图片 / 代码预览、模糊搜索 | ✅ 完成 |
| **P5 收藏 + 主题** | 收藏夹、历史、侧边栏、主题系统、设置页 | ✅ 完成 |
...
> 最后更新:P0–P5 全部完成,P6 待开发(2026-06-11)。
